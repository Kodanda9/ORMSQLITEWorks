...
import com.ailogic.totallsp.ormsqlite.data.DatabaseHelper;
import com.ailogic.totallsp.ormsqlite.data.TeacherDetails;
...
public class ViewTeacherRecordActivity extends Activity implements OnItemClickListener, OnItemLongClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			listview.setAdapter(new RecordArrayAdapter(ViewTeacherRecordActivity.this, R.layout.list_item, teacherList, teacherDao));
